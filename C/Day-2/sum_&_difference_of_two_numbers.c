...
// When we sum the floating-point numbers 4.0 and 2.0,6.0 we get . When we subtract the second number 2.0 from the first number 4.0, we get 2.0 as their difference.
